...
public static class EventManager
{
    ...
    public static Action<IDroppable> OnInventoryItemMoveEnded;
    ...
    public static void NotifyInventoryItemMoveEnded(IDroppable droppable)
    {
        OnInventoryItemMoveEnded?.Invoke(droppable);
    }
